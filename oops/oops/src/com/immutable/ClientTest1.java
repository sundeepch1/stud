...
public class ClientTest1 {
	...
	public static void main(String[] args) {
		...
		Employee1 e1 =  new Employee1(1001, "KK", new BigDecimal("90000.00"),getDob("04/02/1986"),address1,skills);
		Employee1 e2 =  new Employee1(1002, "Sean", new BigDecimal("40000.00"),getDob("25/02/1985"),address2,skills);
